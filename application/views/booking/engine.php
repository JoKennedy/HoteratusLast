                    ...
                    <div class="content tab">
                        ...
                        <section id="section-2" class="content-current sec">
                            ...
                            <div style="float:right; width:50%; padding-left: 20px;">
                                ...
                                <blockquote>
                                    &lt;iframe src="
                                    <?= lang_url() ?>booking/widget/
                                        <?= insep_encode(hotel_id()); ?>" frameborder="0" width="100%" height="260"&gt;&lt;/iframe&gt;
                                </blockquote>
                                <h3>Source Code For MultiProperty</h3>
                                <h4>Copy de following code and paste in your page inside the tag body</h4>
                                <blockquote>
                                    &lt;iframe src="
                                    <?= lang_url() ?>booking/widgetmulti/
                                        <?= insep_encode(user_id()); ?>" frameborder="0" width="100%" height="260"&gt;&lt;/iframe&gt;
                                </blockquote>
                                <div id="facebook">
