        ...
        <div class="graph">
            <div class="table-responsive">
                <div style="float: left;" class="buttons-ui">
                    ...
                    <input id="date1" style="background-color: white; " type="date" class="btn blue" value="" placeholder="">
                    <input id="date2" style="background-color: white; " type="date" class="btn blue" value="" placeholder="">
                ...
                <?php if (count($AllReservationList)==0) {echo '<h4> No Record Found!</h4>';} 
							...
							else
							{
								...
								echo '<label style="float: left;" id="totales" class="control-label"></label>';
								echo ' <ul id="pagination" style="float: right;" class="pagination pagination-sm">
...
document.querySelector("#mostrar").onchange = function() {
    $TableFilter4("#Reservationlist", this.value);
}
...
$TableFilter2("#Reservationlist", 10);
</script>