<div class="outter-wp">
    ...
    <div class="forms-main">
        <h2 class="inner-tittle">Property Info</h2>
        <div class="graph-form">
            <div class="validation-form">
                <!---->
                <form id="propertyinfo" onsubmit="return savepropertyinfo();">
                    <div class="vali-form">
                        <div class="col-md-6 form-group1">
                            <label class="control-label">Property Name</label>
                            <input name="propertyname" type="text" value="<?= $HotelInfo['property_name'] ?>" placeholder="Property Name" required="">
                        </div>
                        <div class="col-md-6 form-group1 form-last">
                            <label class="control-label controls">Address</label>
                            <input type="text" id="address" name="address" value="<?= $HotelInfo['address'] ?>" placeholder="Address" required="">
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="col-md-12 form-group1 group-mail">
                        <label class="control-label">Email</label>
                        <input type="text" name="email" value="<?= $HotelInfo['email_address'] ?>" placeholder="Email" required="">
                    </div>
                    <div class="clearfix"> </div>
                    <div class="col-md-12 form-group1 group-mail">
                        <label class="control-label">Url</label>
                        <input type="text" name="website" value="<?= $HotelInfo['web_site'] ?>" placeholder="Current Website Url" required="">
                    </div>
                    <div class="clearfix"> </div>
                        ...
                        <select name="currencyid">
                            ...
                            if (count($currency)>0) {
                                ...
                                foreach ($currency as $value) {                                    
                                    echo '<option  value="'.$value['currency_id'].'" '.($HotelInfo['currency']==$value['currency_id']?'selected':'').'>'.$value['currency_name'].'</option>';
                                }
                            }
                            else 
                            {
                          ...
                          <?php
                            if (count($countries)>0) {
                                ...
                                foreach ($countries as $value) {                                    
                                    echo '<option  value="'.$value['id'].'" '.($HotelInfo['country']==$value['id']?'selected':'').'>'.$value['country_name'].'</option>';
                                }
                            }
                            else 
                            {
                    ...
                    <div class="vali-form">
                        <div class="col-md-6 form-group1">
                            ...
                            <input name="Phone" type="text" value="<?= $HotelInfo['mobile'] ?>" placeholder="Phone Number" required="">
                        </div>
                        <div class="col-md-6 form-group1">
                            <label class="control-label">Zip Code</label>
                            <input name="zipcode" type="text" value="<?= $HotelInfo['zip_code'] ?>" placeholder="Zip Code" required="">
                        </div>
                        <div class="clearfix"> </div>
                        <div class="col-md-6 form-group1 form-last">
                    ...
                    $.ajax({
                        ...
                        success: function(html) {
		                    ...
		                    else
		                    {
		                        ...
		                        swal({
		                            title: "Error!",
		                            text: "Could not update information please try again later!",
		                            icon: "warning",
		                            button: "Ok!",
		                        }); 
		                    }
