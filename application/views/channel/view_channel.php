...
<div class="bb1"><center><img src="data:image/png;base64,<?php
echo base64_encode(file_get_contents("uploads/" . $image));
?>" class="img img-responsive"></center>
<div class="row mar-top20" align="center">
<?php
if ($channel_status == '1' && ($channel_id == 2 && ($ch->xml_type == 2 || $ch->xml_type == 3)) || ($channel_id != 2 & $channel_id != 39)) {
?>
<a href="<?php
    echo lang_url();
?>mapping/settings/<?php
    echo insep_encode($channel_id);
?>">
...
?>
     <p><i class="fa fa-check"></i> <?php
        echo get_data(OPEATIONS, array(
            'operations_id' => $support
        ))->row()->operation_name;
?> </p>
    <?php
    }
...
<div class="row mar-top20" align="center">
<?php
if ($channel_status == '1' && ($channel_id == 2 && ($ch->xml_type == 2 || $ch->xml_type == 1)) || ($channel_id != 2 && $channel_id != 39)) {
    include_once APPPATH . 'models/mapping_model.php';
    $map_model = new Mapping_model();
    $map       = $map_model->get_all_mapping_rooms($channel_id);
    
    if ($map != 0) {
?>
<button type="button" class="btn btn-primary" id="getResrvationFromChannel" channel_id="<?php
        echo insep_encode($channel_id);
?>">Import Bookings</button>
<?php
    }
} 
if($channel_id == 40 || $channel_id == 42 || $channel_id == 41)
{
            require_once(APPPATH.'models/hotusagroup_model.php'); 
            $hotusa = new hotusagroup_model();
            $map  =   $hotusa->get_all_mapping_rooms($channel_id);
            if ($map != 0)
            {
?>
<button type="button" class="btn btn-primary" id="getResrvationFromChannel" channel_id="<?php
        echo insep_encode($channel_id); ?>">Import Bookings</button>
<?php 
}
}
?>
...
if (isset($ch->user_connect_id)) {
    ...
    if ($channel_id == '2') {
        $ch = get_data(B_WAY, array(
            'id' => '3',
            'type' => '2',
            'channel_id' => '2'
        ), 'username as user_name,password as user_password')->row();
    }
    if ($channel_id == '1') {
        $ch = get_data(B_WAY, array(
            'id' => '6',
...
<div class="room_form  col-md-8">
  ...
  <form class="form-horizontal" method="post" name="connect_channel" id="connect_channel" action="<?php
echo lang_url();
?>mapping/connect_channel">
...
?>" id="channel_id">
  ...
  <div class="form-group border-channel">
    ...
    <label class="radio-inline">
        <input type="radio" value="enabled" <?php
if (isset($ch->status)) {
...
?>  id="inlineRadio2" name="optionenable"> Enabled
    </label>
    <label class="radio-inline">
        <input type="radio" value="disabled" <?php
if (isset($ch->status)) {
    if ($ch->status == 'disabled') {
        echo 'checked="checked"';
    }
}
?> id="inlineRadio3" name="optionenable"> Disabled
    </label>
    <label class="radio-inline">
    </label>
    <label class="radio-inline">
  ...
  <input type="hidden" name="user_connect" value="<?php
if (isset($ch->user_connect_id)) {
    echo $ch->user_connect_id;
}
?>">
  <!--<div class="form-group border-channel">
    ...
    <div class="col-sm-2 mar-top7">
      <input type="text" name="rate_conversion" value="<?php
if (isset($ch->rate_multiplier)) {
    echo $ch->rate_multiplier;
}
?>" placeholder="" id="inputEmail3" class="form-control">
    </div>
    <div class="col-sm-5">
  ...
  <?php
if ($channel_id != 15 && $channel_id != 2 && $channel_id != 1 && $channel_id != 39) {
?>
 <div class="form-group border-channel">
    ...
    if (isset($ch->user_name)) {
        echo $ch->user_name;
    }
?>" name="user_name" placeholder="" id="ch_user_name" class="form-control">
    </div>
         <span class="errors mar-top7">*</span><i>Required</i>
    <div class="col-sm-5">
      <label for="exampleInputName2"></label>
  ...
  <div class="form-group border-channel">
    ...
    if (isset($ch->user_password)) {
        echo $ch->user_password;
    }
?>" name="user_password" placeholder="" id="ch_user_password" class="form-control">
          </div>
          <span class="errors mar-top7">*</span><i>Required</i>
    ...
    <?php
} elseif ($channel_id == 39) {
?>
 
 <div class="form-group border-channel">
    <label class="col-sm-5 control-label" for="inputEmail3"> <?php
    if ($channel_id == 39) {
        echo "Secrect";
    }
?> Api Key  <i class="fa fa-exclamation-circle"></i></label>
    <div class="col-sm-4 mar-top7">
      <input type="password" value="<?php
    if (isset($ch->user_password)) {
        echo $ch->user_password;
...
?>" name="user_name" placeholder="" id="ch_user_name" class="form-control" readonly> <!--readonly-->
  </div>
      <span class="errors mar-top7">*</span><i>Required</i>
    <div class="col-sm-5">
      <label for="exampleInputName2"></label>
  ...
  <div class="form-group border-channel">
    ...
    <div class="col-sm-4 mar-top7">
      <input type="password" value="<?php
    echo $channel_password;
?>" name="user_password" placeholder="" id="ch_user_password" class="form-control" readonly> <!--readonly-->
      </div>
      <span class="errors mar-top7">*</span><i>Required</i>
...
?>
  ...
  <?php
if ((($channel_id == 14 && isset($ch->hotel_channel_id) != '') || $channel_id != '14') && $channel_id != '39') {
?>
 <div class="form-group border-channel">
    <label class="col-sm-5 control-label" for="inputEmail3">Hotel ID  <i class="fa fa-exclamation-circle"></i></label>
        <div class="col-sm-4 mar-top7">
          <input type="text" value="<?php
    if (isset($ch->hotel_channel_id)) {
        echo $ch->hotel_channel_id;
    }
?>" name="hotel_channel_id" placeholder="" id="hotel_channel_id" class="form-control">
          </div>
          <span class="errors mar-top7">*</span><i>Required</i>
...
if ($channel_id == '9') {
?>
 <div class="form-group border-channel" style="display:none;">
    <label class="col-sm-5 control-label" for="otherID">Other ID  <i class="fa fa-exclamation-circle"></i></label>
        <div class="col-sm-4 mar-top7">
          <input type="text" value="<?php
    if (isset($ch->other_id)) {
        echo $ch->other_id;
    }
?>" name="other_id" placeholder="" id="other_id" class="form-control">
          </div>
          <span class="errors mar-top7">*</span><i>Required</i>
...
?>
  ...
  <div class="form-group border-channel">
    ...
    if (isset($ch->reservation_email)) {
        echo $ch->reservation_email;
    }
?>" name="email_address" placeholder="" id="inputEmail3" class="form-control">
          <div align="right">
...
if ($channel_id == 15  || $channel_id == 14 ) {
?>
 <div class="form-group border-channel">
    <label class="col-sm-5 control-label" for="inputEmail3"> <?php
    echo $channel_id == '15' ? 'CMId' : 'codeSupplier';
?> <i class="fa fa-exclamation-circle"></i></label>
    <div class="col-sm-4 mar-top7">
      <input type="text" value="<?php
    echo $ch->cmid;
?>" name="cmid" placeholder="" id="cmid" class="form-control"><!--readonly-->
          <div align="right">
...
?>" name="web_id" placeholder="" id="web_id" class="form-control">
          <div align="right">
...
?>
 <div class="form-group border-channel">
    ...
    <div class="col-sm-6">
      <label class="radio-inline">
        <input type="radio" value="2" id="inlineRadio2" name="xml_select" onchange="getusercredentials(this.value)" <?php
    if (isset($ch->xml_type)) {
        if ($ch->xml_type == 2) {
?>checked<?php
        }
    }
?>> 2 ways (Import Rates-Update Availabilities-Rates-Restrictions)
      </label>
    </div>
    <label class="col-sm-3 control-label" for="inputPassword3"></label>
    <div class="col-sm-4">
    <label class="radio-inline">
      <input type="radio" value="1" onchange="getusercredentials(this.value)" id="inlineRadio2" name="xml_select" <?php
    if (isset($ch->xml_type)) {
        if ($ch->xml_type == 1) {
?>checked<?php
        }
    }
?>> 1 way (Import Reservation Only)
    </label>
    </div>
    <div class="col-sm-4">
    <label class="radio-inline">
      <input type="radio" value="3" onchange="getusercredentials(this.value)" id="inlineRadio3" name="xml_select" <?php
    if (isset($ch->xml_type)) {
        if ($ch->xml_type == 3) {
?>checked<?php
        }
    }
?>> 1 way (Update Rates And Availability Only)
    </label>
...
?>
  ...
  <div align="left">
  <?php
if ($channel_id == 5 && isset($ch->user_name)) {
?>
...
<?php
$this->load->view('channel/dash_sidebar');
?>      
...
<form class="form-horizontal" method="post" name="ask_for_connection" id="ask_for_connection" action="<?php
echo lang_url();
?>channel/askforconnection" onsubmit="return validate();">
...
echo $askforconnection->email_address;
?>" />
<div class="form-group">
<label class="col-sm-2 control-label" for="inputEmail3">Subject </label>
<div class="col-sm-10">
<input type="text" name="subject" placeholder="" id="inputEmail3" class="form-control" value="Xml connection Requested for Property <?php
echo $askforconnection->property_name;
?>(Id <?php
echo $ch->hotel_channel_id;
?>)">
</div>                                        
...
Address: <?php
echo $askforconnection->address . "," . $askforconnection->town . "-" . $askforconnection->zip_code;
?>
...
Web: <?php
echo $askforconnection->web_site;
?>
...
url: <?php
echo lang_url();
?>reservation/getHotelbedsReservation/<?php
echo insep_encode($channel_id);
?>
